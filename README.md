...
- [7. ASP.NET Core](#7-aspnet-core)
  - [7.1 Configuration & Options](#71-configuration--options)
  - [7.2 HTTP Fundamentals](#72-http-fundamentals)
  - [7.3 Azure Deployment](#73-azure-deployment)
- [8. Docker](#8-docker)
  - [8.1 Container Basics](#81-container-basics)
  - [8.2 Container Lifecycle](#82-container-lifecycle)
  - [8.3 Container Operations](#83-container-operations)
  - [8.4 Image Building](#84-image-building)
- [9. Quality Assurance](#9-quality-assurance)
  - [9.1 Unit Testing](#91-unit-testing)
  - [9.2 Mocking](#92-mocking)
- [10. Project Overview](#10-project-overview)
...
ASP.NET Core configuration patterns, HTTP fundamentals, and Azure deployment strategies.

### 7.1 Configuration & Options

| Document | Path |
|----------|------|
| [Options Pattern](./ASP.NET/mds/01-options-pattern.md) | `ASP.NET/mds/01-options-pattern.md` |

Strongly-typed configuration binding, IOptions and IOptionsSnapshot, configuration validation, and Options pattern best practices.

[Back to Top](#table-of-contents)

| Document | Path |
|----------|------|
| [User Secrets](./ASP.NET/mds/02-user-secrets.md) | `ASP.NET/mds/02-user-secrets.md` |

Secret Manager tool, environment-specific configuration, secure credential storage in development, and UserSecretsId for project linkage.

[Back to Top](#table-of-contents)

| Document | Path |
|----------|------|
| [Configuration Sources](./ASP.NET/mds/03-configuration-sources.md) | `ASP.NET/mds/03-configuration-sources.md` |

Chained configuration sources, environment variables, JSON file providers, in-memory sources, and custom configuration providers.

[Back to Top](#table-of-contents)

| Document | Path |
|----------|------|
| [Remove OnConfiguring](./ASP.NET/mds/04-remove-onconfiguring.md) | `ASP.NET/mds/04-remove-onconfiguring.md` |

DbContext pooling, external configuration via UseSqlServer/UseNpgsql, connection string injection, and removing OnConfiguring for testability.

[Back to Top](#table-of-contents)

### 7.2 HTTP Fundamentals

| Document | Path |
|----------|------|
| [SSL/TLS](./ASP.NET/mds/05-ssl-tls.md) | `ASP.NET/mds/05-ssl-tls.md` |

HTTPS enforcement, certificate configuration, TLS 1.2/1.3 support, Kestrel SSL bindings, and certificate rotation.

[Back to Top](#table-of-contents)

| Document | Path |
|----------|------|
| [HTTP Methods](./ASP.NET/mds/06-http-methods.md) | `ASP.NET/mds/06-http-methods.md` |

GET, POST, PUT, PATCH, DELETE semantics, idempotency principles, method override headers, and RESTful design patterns.

[Back to Top](#table-of-contents)

| Document | Path |
|----------|------|
| [HTTP Status Codes](./ASP.NET/mds/07-http-status-codes.md) | `ASP.NET/mds/07-http-status-codes.md` |

1xx informational, 2xx success, 3xx redirection, 4xx client errors, 5xx server errors, and appropriate status code selection.

[Back to Top](#table-of-contents)

| Document | Path |
|----------|------|
| [HTTP Versions](./ASP.NET/mds/08-http-versions.md) | `ASP.NET/mds/08-http-versions.md` |

HTTP/1.1 vs HTTP/2 vs HTTP/3, protocol negotiation, multiplexed streams, header compression, and QUIC transport.
...
| Document | Path |
|----------|------|
| [EF Core Transactions](./ASP.NET/mds/09-efcore-transactions.md) | `ASP.NET/mds/09-efcore-transactions.md` |

TransactionScope usage, explicit transactions, SavePoints, distributed transactions across multiple DbContexts, and Azure SQL elastic transactions.

[Back to Top](#table-of-contents)

| Document | Path |
|----------|------|
| [EF Core Interceptors](./ASP.NET/mds/10-efcore-interceptors.md) | `ASP.NET/mds/10-efcore-interceptors.md` |

Command interceptors, connection interceptors, transaction interceptors, slow query detection, and audit logging patterns.

[Back to Top](#table-of-contents)

| Document | Path |
|----------|------|
| [Azure VM vs App Service](./ASP.NET/mds/11-azure-vm-vs-app-service.md) | `ASP.NET/mds/11-azure-vm-vs-app-service.md` |

Infrastructure-as-a-Service vs Platform-as-a-Service, scaling capabilities, cost considerations, deployment options, and decision framework.

[Back to Top](#table-of-contents)

| Document | Path |
|----------|------|
| [Azure Configurations](./ASP.NET/mds/12-azure-configurations.md) | `ASP.NET/mds/12-azure-configurations.md` |

Azure App Service configuration, Application Settings, connection strings, Key Vault integration, managed identities, and deployment slots.
...
Container fundamentals, container lifecycle management, and image building strategies.

### 8.1 Container Basics

| Document | Path |
|----------|------|
| [Docker Run & Basic Commands](./Docker/mds/01-docker-run-basics.md) | `Docker/mds/01-docker-run-basics.md` |

Docker Run command, override commands, Docker PS for listing containers, and basic container operations.
...
| Document | Path |
|----------|------|
| [Container Lifecycle](./Docker/mds/02-container-lifecycle.md) | `Docker/mds/02-container-lifecycle.md` |

Container states (Created, Running, Stopped), Docker Create, Docker Start, Docker System Prune, and container cleanup.

[Back to Top](#table-of-contents)

### 8.3 Container Operations

| Document | Path |
|----------|------|
| [Container Logging & Stopping](./Docker/mds/03-logging-stopping.md) | `Docker/mds/03-logging-stopping.md` |

Docker Logs, Docker Stop vs Docker Kill, SIGTERM vs SIGKILL signals, and graceful shutdown patterns.

[Back to Top](#table-of-contents)

| Document | Path |
|----------|------|
| [Container Execution](./Docker/mds/04-container-execution.md) | `Docker/mds/04-container-execution.md` |

Docker Exec, -it flag, STDIN/STDOUT/STDERR streams, interactive shell access, and container isolation levels.
...
| Document | Path |
|----------|------|
| [Docker Image Building](./Docker/mds/05-docker-image-building.md) | `Docker/mds/05-docker-image-building.md` |

Dockerfile instructions (FROM, RUN, CMD), BuildKit features, image tagging, caching strategies, and Docker Commit for manual image creation.
...
**Full Stack .NET Path:**
C# Fundamentals -> OOP -> Database Design -> EF Core (Migrations, DbContext, DI) -> Async/Await -> Testing -> ASP.NET Core -> Docker

### Repository Statistics

- Total Documents: 74+ technical deep-dives
- Primary Categories: 10 major domains
- C# & .NET Topics: 30 documents
- Database Topics: 13 documents
- EF Core Topics: 14 documents
- ASP.NET Core Topics: 12 documents
- Docker Topics: 5 documents
...
**Container Proficiency:** Understanding containerization fundamentals, image building best practices, and container orchestration basics.

**Cloud Deployment:** Mastering Azure deployment options, configuration management, and cloud-native development patterns.
