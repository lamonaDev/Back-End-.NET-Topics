...
- [6. EF Core](#6-ef-core)
  ...
  - [6.8 DbSet, Concurrency & Relationships](#68-dbset-concurrency--relationships)
  - [6.9 Advanced Mapping](#69-advanced-mapping)
  - [6.10 Query Performance](#610-query-performance)
  - [6.11 Query Translation & Debugging](#611-query-translation--debugging)
  - [6.12 LINQ, Expressions & Functions](#612-linq-expressions--functions)
  - [6.13 Interceptors & Raw SQL](#613-interceptors--raw-sql)
  - [6.14 .NET Ecosystem Tools](#614-net-ecosystem-tools)
- [7. Quality Assurance](#7-quality-assurance)
  - [7.1 Unit Testing](#71-unit-testing)
  - [7.2 Mocking](#72-mocking)
- [8. Quality Assurance](#6-quality-assurance)
  - [8.1 Unit Testing](#61-unit-testing)
  - [8.2 Mocking](#62-mocking)
- [9. Project Overview](#7-project-overview)
